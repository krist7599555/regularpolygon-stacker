/**
 * https://www.onlinegdb.com/edit/HYTv2BeqJ
 * https://codepen.io/krist7599555/pen/OJzJBML
 * https://github.com/krist7599555/regularpolygon-stacker
 */
#include <iostream>
#include <string>
#include <utility>
...
public:
   ...
   * \__/    \__/
   */
  double circum_radius() const { return 0.5 * side_length * (1.0 / sin(M_PI / n)); }
  double in_radius() const { return circum_radius() * cos(M_PI / n); }
  double exterior_angle() const { return 2 * M_PI / n; }
  double interior_angle() const { return (n - 2) * M_PI / n; }
